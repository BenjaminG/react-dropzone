...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Dropzone = function (_React$Component) {
	  ...
	  _createClass(Dropzone, null, [{
	    ...
	    value: function resetImageOrientation(image) {
	  ...
	  _createClass(Dropzone, [{
	    ...
	    value: function onDrop(evt) {
	      ...
	      if (multiple) {
	        Promise.all(fileList.map(Dropzone.resetImageOrientation)).then(function (blobs) {
	          blobs.forEach(function (blob, index) {
	            if (!disablePreview) {
	              fileList[index].preview = blob; // eslint-disable-line no-param-reassign
	            }
	            if ((0, _utils.fileAccepted)(fileList[index], accept) && (0, _utils.fileMatchSize)(fileList[index], maxSize, minSize)) {
